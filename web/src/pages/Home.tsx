...
import { Sparkles, Mail, Wallet, ArrowRight, Shield, Zap, CheckCircle } from 'lucide-react'
    ...
    <div className="max-w-4xl mx-auto px-4 py-8 sm:py-12 space-y-12">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Connect your accounts to start minting</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          ...
          <div 
            ...
            style={{
              background: isGmailConnected ? 'var(--glass-bg-primary)' : 'transparent',
          ...
          >
            <div 
              ...
              style={{
                background: isGmailConnected ? 'var(--Controls-Selected)' : 'var(--glass-bg-secondary)',
              }}
            >
              {isGmailConnected ? (
                <CheckCircle className="h-5 w-5 text-white" />
              ) : (
                <Mail className="h-5 w-5" style={{ color: 'var(--page-text-secondary)' }} />
              )}
            </div>
          ...
          <div 
            className="flex items-center gap-4 p-4 rounded-lg"
            style={{
              background: isWalletConnected ? 'var(--glass-bg-primary)' : 'transparent',
          ...
          >
            <div 
              className="flex items-center justify-center w-10 h-10 rounded-full"
              style={{
                background: isWalletConnected ? 'var(--Controls-Selected)' : 'var(--glass-bg-secondary)',
              }}
            >
              {isWalletConnected ? (
                <CheckCircle className="h-5 w-5 text-white" />
              ) : (
                <Wallet className="h-5 w-5" style={{ color: 'var(--page-text-secondary)' }} />
              )}
            </div>
            <div className="flex-1">
              <h3 
